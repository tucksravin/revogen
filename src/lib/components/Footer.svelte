...
<DelayedLink href='/about' class="hover:opacity-85 transition-opacity duration-300 uppercase drop-shadow-sm">About</DelayedLink>
<DelayedLink href='/distribution-opportunities' class="hover:opacity-85 transition-opacity duration-300 uppercase drop-shadow-sm">distribution<br/>opportunities</DelayedLink>
<DelayedLink href='/distributor-resource-hub' class="hover:opacity-85 transition-opacity duration-300 uppercase drop-shadow-sm">distributor resource hub</DelayedLink>
<DelayedLink href='/ocular' class="hover:opacity-85 transition-opacity duration-300 uppercase drop-shadow-sm">ocular grafts</DelayedLink>
