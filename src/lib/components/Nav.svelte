...
{#if isNavModalOpen}
  <div class="fixed w-screen h-screen top-0 left-0 z-10" transition:fade>
    ...
    <ContentWidth class="my-20 md:my-48 md:px-24">
      ...
      <div class="flex flex-col md:flex-row gap-6 md:gap-10 mt-10 text-white">
        <div class="w-full md:w-1/2 flex flex-col gap-6 md:gap-10 nav">
          <a href="/about" class="bump w-fit" onclick={()=>isNavModalOpen=false}
            ><h2 class="hover:text-white/80 transition duration-300 ease-out">
              About
            </h2></a
          >
          <a href="/distribution-opportunities" class="bump w-fit" onclick={()=>isNavModalOpen=false}
            ><h2 class="hover:text-white/80 transition duration-300 ease-out">
              Distribution <br /> Opportunities
            </h2></a
          >
          <a href="/distributor-resources" class="bump w-fit" onclick={()=>isNavModalOpen=false}
            ><h2 class="hover:text-white/80 transition duration-300 ease-out">
        ...
        <div class="w-full md:w-1/2 flex flex-col gap-6">
          <a href="/surgical-grafts" class="bump w-fit" onclick={()=>isNavModalOpen=false}
            ><h2 class="hover:text-white/80 transition duration-300 ease-out">
              Surgical Grafts
            </h2></a
          >
          <a href="/surgical-grafts/allografts" class="bump w-fit ml-8 md:ml-0" onclick={()=>isNavModalOpen=false}
            ><h2 class="hover:text-white/80 transition duration-300 ease-out">
              Allografts
            </h2></a
          >
          <a href="/surgical-grafts/sports-medicine" class="bump w-fi ml-8 md:ml-0" onclick={()=>isNavModalOpen=false}
            ><h2 class="hover:text-white/80 transition duration-300 ease-out">
              Sports Medicine Grafts
            </h2></a
          >
          <a href="/surgical-grafts/amnion-patches" class="bump w-fit ml-8 md:ml-0" onclick={()=>isNavModalOpen=false}
            ><h2 class="hover:text-white/80 transition duration-300 ease-out">
              Amnion Patches
            </h2></a
          >
          <a href="/surgical-grafts/synthetics" class="bump w-fit ml-8 md:ml-0" onclick={()=>isNavModalOpen=false}
            ><h2 class="hover:text-white/80 transition duration-300 ease-out">
              Synthetics
            </h2></a
          >
          <a href="/wound-care" class="bump w-fit" onclick={()=>isNavModalOpen=false}
            ><h2 class="hover:text-white/80 transition duration-300 ease-out">
              Wound Care Grafts
            </h2></a
          >
          <a href="/ocular" class="bump w-fit" onclick={()=>isNavModalOpen=false}
            ><h2 class="hover:text-white/80 transition duration-300 ease-out">
              Ocular Grafts
            </h2></a
          >
...
<ContentWidth class="h-24 flex flex-row justify-between items-center">
  <a href="/" class="bump" onclick={()=>isNavModalOpen=false}
    ><img
      src={logo}
