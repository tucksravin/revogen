...
<div class='fixed w-screen h-screen top-0 left-0 -z-10'>
	...
	<!-- Option 0 - Blue -->
	<div class='absolute w-[125vw] h-[125vh] -top-[10vh] -left-[10vw] add-noise transition-opacity delay-200 duration-2400 ease-out {$gradientTheme===0?"opacity-100":"opacity-0"}'>
	...
	<!-- Option 1 - Pink -->
	<div class='absolute w-[125vw] h-[125vh] -top-[10vh] -left-[10vw] transition-opacity add-noise  duration-2400 ease-out {$gradientTheme===1?"opacity-100":"opacity-0"}'>
	...
	<!-- Option 2 - Deep Blue -->
	<div class='absolute w-[125vw] h-[125vh] -top-[10vh] -left-[10vw] add-noise transition-opacity duration-2400 ease-out {$gradientTheme===2?"opacity-100":"opacity-0"}'>
	...
	<!-- Option 3 - Teal -->
	<div class='absolute w-[125vw] h-[125vh] -top-[10vh] -left-[10vw] add-noise transition-opacity duration-2400 ease-out {$gradientTheme===3?"opacity-100":"opacity-0"}'>
